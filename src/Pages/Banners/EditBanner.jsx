...
const EditBanner = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get(`http://localhost:4000/api/get-Banners`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`http://localhost:4000/api/update-Banners/${id}`, data);
                ...
                {loading ? (
                    ...
                    <form className="row g-3" onSubmit={handleSubmit}>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="file" onChange={handleChange} name='image' className="form-control" id="bannerImage" />
                        </div>
