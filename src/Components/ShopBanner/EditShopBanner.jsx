...
const EditShopBanner = () => {
    ...
    const handleFetch = async () => {
        try {
            ...
            if (filterData.length > 0) {
                setData({
                    BtnTitle: filterData[0].BtnTitle,
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`http://localhost:4000/api/update-sales-Banners/${id}`, data);
                ...
                {loading ? (
                    ...
                    <form className="row g-3" onSubmit={handleSubmit}>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="file" onChange={handleChange} name='image' className="form-control" id="saleBannerImage" />
                        </div>
